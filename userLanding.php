            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="ref.php" class="nav-item nav-link">Referrals</a>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card h-100 wow fadeIn" data-wow-delay="0.5s">
                                    <div class="card-body text-center">
                                        ...
                                        <h5 class="card-title mb-3">Deposits</h5>
                                        <a href="reportUserIn.php" class="btn btn-primary">See Report</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4 wow fadeIn" data-wow-delay="0.5s">
                                <div class="card h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <a href="reportUserOut.php" class="btn btn-primary">See Report</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4 wow fadeIn" data-wow-delay="0.5s">
                                <div class="card h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <a href="ref.php" class="btn btn-primary">See Report</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4 wow fadeIn" data-wow-delay="0.5s">
                                <div class="card h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <h5 class="card-title mb-3">You</h5>
                                        <a href="userProf.php" class="btn btn-primary">View Profile</a>
                                    </div>
                                </div>
                            </div>
                        </div>
